"""
Django settings for ParkifyApi project.
...
SECRET_KEY = 'django-insecure-^ryl&31q)pmrkujiov-+t9t-wb(s)&-i6s!iv-h1riz2@6znai'
...
WSGI_APPLICATION = 'ParkifyApi.wsgi.application'
